...
const Login = () => {
    ...
    return (
        <div className="w-full h-screen bg-secondary flex  items-center justify-center p-4 " >
            ...
            <h3 className=" text-secondary text-[28px] sm:text-4xl font-primary font-bold"> Good to see you again </h3>
                <form className="  w-full flex items-center justify-center gap-4  flex-col  " onSubmit={formik.handleSubmit}>
                    ...
                    <div className="w-full flex items-center justify-end flex-col ">
                       ...
                       <span className=" p-2 bg-active rounded-full text-primary text-xl absolute top-[28px] right-[10px] "
                        onClick={showHandle}> { show ? <FaEye/> : <FaEyeSlash/>} </span>
                        </div>
                        <div className=" w-full flex items-start justify-start">
                        {
                            formik.errors.password && 
                            <p className=" text-active text-start capitalize text-sm ">
                    ...
                    <div className="w-full flex items-center justify-center   " >
                        <button className=" px-[50px] py-1 bg-orange-500 hover:bg-primary duration-300 text-primary rounded-xl text-lg  font-semibold  " 
                        type="submit"> Login </button>
                    </div>
                </form>

                <div className="w-full flex items-center justify-between ">
                    <Link className=" underline text-sm hover:text-active underline-offset-4 text-secondary " to="/signup"> don't have an account? </Link>
                    <Link to="" className="underline text-sm hover:text-active underline-offset-4 text-secondary"> Forget password </Link>
                </div>
            </div>
