...
{true}  className='w-full h-auto mb-[20px] sm:mb-[50px]  ' >
                <div className=' w-full   sm:h-[auto] md:h-auto cursor-pointer relative flex items-center justify-center '>
                    <img className='w-full sm:h-[auto] md:h-auto object-contain cursor-pointer' src="https://i.ibb.co.com/FLYWL7KH/2-01.jpg" />
                    <div className='sm:flex hidden bg-[#1a1010]/30 backdrop-blur-sm absolute top-[6px] px-[20px]   '>
